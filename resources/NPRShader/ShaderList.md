...
| \_NoOutline_DoubleShadeWithFeather_Transparent_StencilOut_           | UnityChanToonShader/NoOutline/ToonColor_DoubleShadeWithFeather_Transparent_StencilOut                   |
...
| \_Tess_NoOutline_AngelRing_ShadingGradeMap_TransClipping_            | UnityChanToonShader/Tessellation/NoOutline/AngelRing/ToonColor_ShadingGradeMap_TransClipping            |
...
| \_TessLight_ShadingGradeMap_StencilMask_                             | UnityChanToonShader/Tessellation/Light/Toon_ShadingGradeMap_StencilMask                                 |
...
| ---------------------------------- | --------------------------------------------- |
| \_lilToon_                         | lilToon                                       |
| \_lilToon_FurOnly_Cutout_          | _lil/[Optional] lilToonFurOnlyCutout          |
| \_lilToon_FurOnly_Transparent_     | _lil/[Optional] lilToonFurOnlyTransparent     |
| \_lilToon_FurOnly_TwoPass_         | _lil/[Optional] lilToonFurOnlyTwoPass         |
| \_lilToon_OutlineOnly_             | _lil/[Optional] lilToonOutlineOnly            |
| \_lilToon_OutlineOnly_Cutout_      | _lil/[Optional] lilToonOutlineOnlyCutout      |
| \_lilToon_OutlineOnly_Transparent_ | _lil/[Optional] lilToonOutlineOnlyTransparent |
| \_lilToon_Overlay_                 | _lil/[Optional] lilToonOverlay                |
| \_lilToon_Overlay_OnePass_         | _lil/[Optional] lilToonOverlayOnePass         |
| \_lilToonLite_Overlay_             | _lil/[Optional] lilToonLiteOverlay            |
| \_lilToonLite_Overlay_OnePass_     | _lil/[Optional] lilToonLiteOverlayOnePass     |
